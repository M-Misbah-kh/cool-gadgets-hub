...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Honest reviews, comparisons, and top picks for the latest tech gadgets, smart devices, and accessories." },
      { property: "og:site_name", content: "Cool Gadgets Hub" },
